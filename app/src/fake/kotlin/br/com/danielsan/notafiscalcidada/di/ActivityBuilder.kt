...
import br.com.danielsan.notafiscalcidada.features.ranking.RankingActivity
...
abstract class ActivityBuilder {
    ...
    @PerActivity
    @ContributesAndroidInjector(modules = arrayOf(PresenterModule::class, FakeRepositoryModule::class))
    ...
    @PerActivity
    @ContributesAndroidInjector(modules = arrayOf(PresenterModule::class, FakeRepositoryModule::class))
    internal abstract fun bindDonationActivity(): AdoptActivity

    @PerActivity
    @ContributesAndroidInjector(modules = arrayOf(PresenterModule::class, FakeRepositoryModule::class))
    internal abstract fun bindInvocesActivity(): InvoicesActivity

    @PerActivity
    @ContributesAndroidInjector(modules = arrayOf(FakeRepositoryModule::class))
    internal abstract fun bindRankingActivity(): RankingActivity
